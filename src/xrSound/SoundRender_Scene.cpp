...
{
    // Vestige of legacy EAX SDK environment-size override. EFX path uses
    // CSoundRender_Environment params directly via set_listener.
}


void CSoundRender_Scene::set_environment(u32 /*id*/, CSound_environment** /*dst_env*/)
{
    // Vestige of legacy EAX SDK environment-id override. EFX path uses
    // CSoundRender_Environment params directly via set_listener.
}
