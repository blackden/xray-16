...
- **Зафиксить настоящий buffer overflow в `xrDebug::Fail`** — PAC trap во время FATAL dialog на macOS. Возможно полезно апстрим даже на других платформах. *Связано с Cmd+Q (Cocoa Plan B) — последний обходит этот баг, не чинит.*
